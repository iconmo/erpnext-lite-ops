...
doc_events = {
    "POS Invoice Merge Log": {
        ...
        "on_update_after_submit": "erpnext_lite_ops.pos_duplication.on_pos_invoice_merge_log_update_after_submit",
    },
    "POS Closing Entry": {
        "on_submit": "erpnext_lite_ops.pos_duplication.on_pos_closing_entry_submit",
    },
    "Sales Invoice": {
