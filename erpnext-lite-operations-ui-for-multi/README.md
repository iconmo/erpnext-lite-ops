...
- Route allowlisting and navigation pruning so Lite users stay inside the approved V1 surface
...
- create/write rights on Item, Customer, Supplier, Contact, Address, Item Price, Price List, tax templates, and Payment Terms
...
- Purchase Orders
- Purchase Invoices
- Support records via the homepage support strip or contextual actions:
  - Contacts
  - Addresses
  - Item Prices
  - Price Lists
